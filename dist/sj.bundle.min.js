...
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}var _slicedToArray=function(){function e(e,t){var n=[],r=!0,a=!1,o=void 0;try{for(var i,l=e[Symbol.iterator]();!(r=(i=l.next()).done)&&(n.push(i.value),!t||n.length!==t);r=!0);}catch(s){a=!0,o=s}finally{try{!r&&l["return"]&&l["return"]()}finally{if(a)throw o}}return n}return function(t,n){if(Array.isArray(t))return t;if(Symbol.iterator in Object(t))return e(t,n);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),_createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}();!function(e){function t(r){if(n[r])return n[r].exports;var a=n[r]={exports:{},id:r,loaded:!1};return e[r].call(a.exports,a,a.exports,t),a.loaded=!0,a.exports}var n={};return t.m=e,t.c=n,t.p="",t(0)}([function(e,t,n){window.HTMLElementBase=n(1).HTMLElementBase},function(e,t,n){function r(e){return e instanceof HTMLInputElement||e instanceof HTMLTextAreaElement||e instanceof HTMLSelectElement}var a=n(2),o={"sj-click":"onclick","sj-checked":"onchecked","sj-dblclick":"dblclick","sj-focus":"focus","sj-keydown":"keydown","sj-keypress":"keypress","sj-keyup":"keyup","sj-mousedown":"mousedown","sj-mouseenter":"mouseenter","sj-mouseleave":"mouseleave","sj-mousemove":"mousemove","sj-mouseover":"mouseover","sj-mouseup":"mouseup","sj-paste":"paste","sj-selected":"selected","sj-submit":"onsubmit"},i=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,Object.getPrototypeOf(t).apply(this,arguments))}return _inherits(t,e),_createClass(t,[{key:"createdCallback",value:function(){this.scope={};var e=this.template(),t=document.createElement("div");t.innerHTML=e,this.templateElement=t,this.initialize(),this.render()}},{key:"template",value:function(){throw"Please implement 'template' method"}},{key:"initialize",value:function(){}},{key:"render",value:function(){var e=this;IncrementalDOM.patch(this,function(){for(var t=e.templateElement.children,n=0;n<t.length;++n)e.renderDOM(t[n],e.scope)})}},{key:"renderDOM",value:function(e,t){if(e instanceof Text)return void IncrementalDOM.text(e.textContent);if(!this.shouldHideElement(e,t)){IncrementalDOM.elementOpenStart(e.tagName.toLowerCase());var n=this.renderAttributes(e,t),o=_slicedToArray(n,2),i=o[0],l=o[1],s=i?a.getValueByPath(t,i):null,u=r(e);i&&s&&t[i]&&u&&IncrementalDOM.attr("value",s),IncrementalDOM.elementOpenEnd(e.tagName.toLowerCase());var c=e.childNodes;if(!l)for(var f=0,m=c.length;m>f;++f){var v=c[f];v instanceof Text?i||IncrementalDOM.text(v.textContent):this.renderDOM(v,t)}i&&s&&!u&&IncrementalDOM.text(s),IncrementalDOM.elementClose(e.tagName.toLowerCase())}}},{key:"shouldHideElement",value:function(e,t){var n=e.getAttribute("sj-if");if(n){var r=a.getValueByPath(t,n);if(!r)return!0}return!1}},{key:"renderAttributes",value:function(e,t){for(var n=void 0,r=e.attributes,a=void 0,o=0,i=r.length;i>o;++o){var l=r[o],s=l.name,u=void 0,c=this.renderAttribute(s,l,e,t),f=_slicedToArray(c,2);u=f[0],a=f[1],u&&(n=l.value)}return[n,a]}},{key:"renderAttribute",value:function(e,t,n,r){var a=this,i=void 0,l=void 0;if(e.startsWith("sj-")){var s=o[e];if(s)IncrementalDOM.attr(s,function(e){a[t.value](e)});else if("sj-model"===t.name)i=t.value,IncrementalDOM.attr("onchange",function(e){r[t.value]=e.target.value,a.render()}),r[t.value]||(r[t.value]=n.value);else if("sj-for"===t.name){var u=t.value.match(/^\s*(\w+)\s+in\s+(\w+)\s*$/);if(!u)throw"Invalid sj-for value: "+u;l=!0;var c=u[1],f=u[2],m=n.querySelector("*"),v=!0,h=!1,d=void 0;try{for(var p,y=r[f][Symbol.iterator]();!(v=(p=y.next()).done);v=!0){var b=p.value,j=Object.assign({},r);j[c]=b,this.renderDOM(m,j)}}catch(w){h=!0,d=w}finally{try{!v&&y["return"]&&y["return"]()}finally{if(h)throw d}}}}else{var O=t.value;O=O.replace(/\{\{(\w+)\}\}/g,function(e,t){return r[t]}),IncrementalDOM.attr(t.name,O)}return[i,l]}}]),t}(HTMLElement);e.exports.HTMLElementBase=i},function(e,t){function n(e,t,r){if(e){a("_get: "+t);var o=t.match(/^([a-zA-Z][a-zA-Z0-9_-]*)($|\.|\(\))(.*)/);if(o){if(o[2]){if("."===o[2])return a("hit: "+o[1]),n(e[o[1]],o[3],r);if(o[2].endsWith("()"))return a("hit: "+o),e[o[1]]();throw"Should not reach here"}return a("hit"),e[o[1]]}throw"Invalid path: "+r+" : "+t}}function r(e,t){if(!t)throw"Missing path";return a("getValueByPath: "+t),n(e,t,t)}var a=function(e){};e.exports={getValueByPath:r}}]);