...
IncrementalDOM.attributes['sj-merge-style'] = function (element, name, value) {
  ...
  if (_typeof(value[1]) === 'object') {
    var elStyle = element.style;
    var obj = /** @type {!Object<string,string>} */value[1];
...
var Compiler = function () {
  ...
  _createClass(Compiler, [{
    ...
    value: function renderAttributes(elem, vars) {
      ...
      if (model) {
        if (elem.type === 'checkbox' || elem.type === 'radio') {
          ...
          var input = events['oninput'] || '';
          var compositionstart = events['oncompositionstart'] || '';
          var compositionend = events['oncompositionend'] || '';
          var _i = this.composition_index++;
      ...
      for (var _i2 = 0, _l = normalEvents.length; _i2 < _l; _i2++) {
        var eventName = normalEvents[_i2];
    ...
    key: 'renderStyle',
    value: function renderStyle(elem, codeList) {
      var style = elem.getAttribute('style') || '';
      var sjStyle = elem.getAttribute('sj-style') || 'undefined';
